...
public :
   ...
   Float_t         photonEnergyAK5PFJet[300];   //[nAK5PFJet]
   Float_t         electronEnergyAK5PFJet[300];   //[nAK5PFJet]
   Float_t         muonEnergyAK5PFJet[300];   //[nAK5PFJet]
   Float_t         HFHadronEnergyAK5PFJet[300];   //[nAK5PFJet]
   Float_t         HFEMEnergyAK5PFJet[300];   //[nAK5PFJet]
   Int_t           chargedHadronMultiplicityAK5PFJet[300];   //[nAK5PFJet]
   Int_t           neutralHadronMultiplicityAK5PFJet[300];   //[nAK5PFJet]
   Int_t           photonMultiplicityAK5PFJet[300];   //[nAK5PFJet]
   Int_t           electronMultiplicityAK5PFJet[300];   //[nAK5PFJet]
   Int_t           muonMultiplicityAK5PFJet[300];   //[nAK5PFJet]
   Int_t           HFHadronMultiplicityAK5PFJet[300];   //[nAK5PFJet]
   Int_t           HFEMMultiplicityAK5PFJet[300];   //[nAK5PFJet]
   Float_t         chargedEmEnergyAK5PFJet[300];   //[nAK5PFJet]
   Float_t         neutralEmEnergyAK5PFJet[300];   //[nAK5PFJet]
   Float_t         combinedSecondaryVertexBJetTagsAK5PFJet[300];   //[nAK5PFJet]
   Float_t         combinedSecondaryVertexMVABJetTagsAK5PFJet[300];   //[nAK5PFJet]
   Float_t         jetBProbabilityBJetTagsAK5PFJet[300];   //[nAK5PFJet]
   Float_t         jetProbabilityBJetTagsAK5PFJet[300];   //[nAK5PFJet]
   Float_t         simpleSecondaryVertexHighEffBJetTagsAK5PFJet[300];   //[nAK5PFJet]
   Float_t         simpleSecondaryVertexHighPurBJetTagsAK5PFJet[300];   //[nAK5PFJet]
   Float_t         softMuonBJetTagsAK5PFJet[300];   //[nAK5PFJet]
   Float_t         softMuonByIP3dBJetTagsAK5PFJet[300];   //[nAK5PFJet]
   Float_t         softMuonByPtBJetTagsAK5PFJet[300];   //[nAK5PFJet]
   Float_t         softElectronBJetTagsAK5PFJet[300];   //[nAK5PFJet]
   Float_t         softElectronByIP3dBJetTagsAK5PFJet[300];   //[nAK5PFJet]
   Float_t         softElectronByPtBJetTagsAK5PFJet[300];   //[nAK5PFJet]
