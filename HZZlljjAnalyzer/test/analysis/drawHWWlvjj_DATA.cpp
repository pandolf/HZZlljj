...
int main(int argc, char* argv[]) {
 ...
 // std::string zJets_dataset = "ZJets_alpgen";
  ...
  db->drawHisto( "lept1Eta", "Lepton Eta", "", "Events", true);
  db->drawHisto( "lept2Eta", "Neutrino Eta", "", "Events", true);
  db->drawHisto( "lept1Pt", "Lepton Pt", "GeV/c", "Events", true);
  db->drawHisto( "lept2Pt", "Neutrino Pt", "GeV/c", "Events", true);
  db->drawHisto( "Mdilept", "Dilepton invariant Mass", "GeV/c^{2}", "Events", true);
  db->drawHisto( "Jet1Eta", "Leading jet Eta", "", "Events", true);
  db->drawHisto( "Jet2Eta", "Subleading jet Eta", "", "Events", true);
  db->drawHisto( "Jet1Pt", "Leading jet Pt", "GeV/c", "Events", true);
  db->drawHisto( "Jet2Pt", "Subleading jet Pt", "GeV/c", "Events", true);
  db->drawHisto( "Mdijet", "Dijet invariant Mass", "GeV/c^{2}", "Events", true);
  db->drawHisto( "energyMet", "Missing Energy", "GeV", "Events",true);
   
  db->drawHisto( "lept1Eta_mu", "(Mu) Lepton Eta", "", "Events", true);
  db->drawHisto( "lept2Eta_mu", "(Mu) Neutrino Eta", "", "Events", true);
  db->drawHisto( "lept1Pt_mu", "(Mu) Lepton Pt", "GeV/c", "Events", true);
  db->drawHisto( "lept2Pt_mu", "(Mu) Neutrino Pt", "GeV/c", "Events", true);
  db->drawHisto( "Mdilept_mu", "(Mu) Dilepton invariant Mass", "GeV/c^{2}", "Events", true);
  db->drawHisto( "Jet1Eta_mu", "(Mu) Leading jet Eta", "", "Events", true);
  db->drawHisto( "Jet2Eta_mu", "(Mu) Subleading jet Eta", "", "Events", true);
  db->drawHisto( "Jet1Pt_mu", "(Mu) Leading jet Pt", "GeV/c", "Events", true);
  db->drawHisto( "Jet2Pt_mu", "(Mu) Subleading jet Pt", "GeV/c", "Events", true);
  db->drawHisto( "Mdijet_mu", "(Mu) Dijet invariant Mass", "GeV/c^{2}", "Events", true);
  db->drawHisto( "energyMet_mu", "(Mu) Missing Energy", "GeV", "Events", true);

  db->drawHisto( "lept1Eta_e", "(Ele) Lepton Eta", "", "Events", true);
  db->drawHisto( "lept2Eta_e", "(Ele) Neutrino Eta", "", "Events", true);
  db->drawHisto( "lept1Pt_e", "(Ele) Lepton Pt", "GeV/c", "Events", true);
  db->drawHisto( "lept2Pt_e", "(Ele) Neutrino Pt", "GeV/c", "Events", true);
  db->drawHisto( "Mdilept_e", "(Ele) Dilepton invariant Mass", "GeV/c^{2}", "Events", true);
  db->drawHisto( "Jet1Eta_e", "(Ele) Leading jet Eta", "", "Events", true);
  db->drawHisto( "Jet2Eta_e", "(Ele) Subleading jet Eta", "", "Events",true);
  db->drawHisto( "Jet1Pt_e", "(Ele) Leading jet Pt", "GeV/c", "Events", true);
  db->drawHisto( "Jet2Pt_e", "(Ele) Subleading jet Pt", "GeV/c", "Events", true);
  db->drawHisto( "Mdijet_e", "(Ele) Dijet invariant Mass", "GeV/c^{2}", "Events", true);
  ...
  db->drawHisto( "helicityLD_kinfit_e", "(e) Helicity Angles Likelihood Discriminant", "", "Events", false);
  db->drawHisto( "helicityLD_kinfit_mu", "(mu) Helicity Angles Likelihood Discriminant", "", "Events", false);
  ...
  db->drawHisto( "QGLikelihoodProd_e", "(e) Quark-Gluon Likelihood", "", "Events", false);
  db->drawHisto( "QGLikelihoodJet1_e", "(e) Jet1 Quark-Gluon Likelihood", "", "Events", false);
  db->drawHisto( "QGLikelihoodJet2_e", "(e) Jet2 Quark-Gluon Likelihood", "", "Events", false);
  db->drawHisto( "QGLikelihoodProd_mu", "(mu) Quark-Gluon Likelihood", "", "Events", false);
  db->drawHisto( "QGLikelihoodJet1_mu", "(mu) Jet1 Quark-Gluon Likelihood", "", "Events", false);
  db->drawHisto( "QGLikelihoodJet2_mu", "(mu) Jet2 Quark-Gluon Likelihood", "", "Events", false);

  db->drawHisto( "kinfit2_chiSquareProb", "Jet2 Chi Square Lept-neu Fit", "", "Events", false);
  db->drawHisto( "kinfit2_chiSquareProb_e", "(e) Chi Square Lept-neu Fit", "", "Events", false);
  db->drawHisto( "kinfit2_chiSquareProb_mu", "(mu) Chi Square Lept-neu Fit", "", "Events", false);
  db->drawHisto( "kinfit_chiSquareProb", "Jet2 Chi Square Jet Fit", "", "Events", false);
  db->drawHisto( "kinfit_chiSquareProb_e", "(e) Chi Square Jet Fit", "", "Events", false);
  db->drawHisto( "kinfit_chiSquareProb_mu", "(mu) Chi Square Jet Fit", "", "Events", false);

  db->set_rebin(2);
  db->set_xAxisMin(150.);
  //db->set_yAxisMax(500);
  db->drawHisto( "mWW_kinfit", "WW Inv. Mass", "GeV/c^{2}", "Events", true, 2);
  db->drawHisto( "mWW_kinfit_e", "(e) WW Inv. Mass", "GeV/c^{2}", "Events", true, 2);
  db->drawHisto( "mWW_kinfit_mu", "(mu) WW Inv. Mass", "GeV/c^{2}", "Events", true, 2);
  db->drawHisto( "mWW_kinfitCUT", "WW Inv. Mass After all cuts", "GeV/c^{2}", "Events", true, 2);
  db->drawHisto( "mWW_kinfitCUT_e", "(e) WW Inv. Mass After all cuts", "GeV/c^{2}", "Events", true, 2);
  db->drawHisto( "mWW_kinfitCUT_mu", "(mu) WW Inv. Mass After all cuts", "GeV/c^{2}", "Events", true, 2);
