...
if (len(sys.argv) != 3) and (len(sys.argv) != 4) and (len(sys.argv) != 5):
    print "usage sendOnBatch.py dataset filesPerJob analyzerType=\"HWWlvjj\" flags=\"\""
    sys.exit(1)
dataset = sys.argv[1]
...
diskoutputdir = "/cmshome/pernielu/STORE/MC/Spring11/"+dataset
...
while (len(inputfiles) > 0):
    ...
    outputfile.write('cd /cmshome/pernielu/CMSSW_4_1_3/src ; eval `scramv1 runtime -sh` ; cd -\n')
